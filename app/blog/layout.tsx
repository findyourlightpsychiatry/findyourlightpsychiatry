...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Blog - Mental Health Insights - Find Your Light Psychiatry",
    description: "Read articles and insights about mental health, therapy, ADHD, adjustment disorders, relationships, seasonal affective disorder, sleep, and mindfulness.",
    url: "/blog",
  },
  twitter: {
    card: "summary",
    title: "Blog - Mental Health Insights - Find Your Light Psychiatry",
    description: "Read articles and insights about mental health, therapy, ADHD, and more.",
  },
};
